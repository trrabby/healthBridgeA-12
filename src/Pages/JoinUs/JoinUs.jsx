                    ...
                    <div className='w-full mx-auto flex flex-col items-center justify-center  text-black bg-accent p-5 min-h-[calc(100vh-270px)] rounded-xl space-y-2 font-extrabold md:my-5'>
                        <form onSubmit={handleForm} className='mx-auto mt-10 flex flex-col gap-5 w-full lg:w-8/12'>
                            ...
                            <label className="input input-bordered flex items-center gap-2 animate__animated animate__flipInX animate__slow	1s">
                                ...
                                <input className='text-black w-full p-3 rounded-lg' type="email" name='email' placeholder="Email" />
                            </label>
                            ...
                            <div>
                                <label className="input input-bordered flex items-center gap-2 animate__animated animate__flipInX animate__slow 1s">
                                    ...
                                    <input className='text-black w-full p-3 rounded-lg' type={toggle ? "text" : "password"} placeholder='Password' name='pass' />
