...
export const AddCamp = () => {
    ...
    const onSubmit = async (formInfo) => {
        ...
        try {
            const { data } = await axiosCommon.post('/blogs', infoWithAddl)
            if (data.insertedId) {
    ...
    return (
        <div className=''>
            ...
            <div className="lg:w-full w-10/12 mx-auto lg:min-h-[calc(100vh-170px)] bg-cover bg-center  rounded-lg mb-5 flex flex-col items-center justify-center text-center border">
