...
export const Footer = () => {
    ...
    return (
        ...
        <div>
            ...
            <footer id="footer" className="bg-third text-accent">
                <div className="relative mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 lg:pt-24">
                    ...
                    <div className="lg:flex lg:items-center lg:justify-between text-fourth">
                        <div data-aos="fade-right" data-aos-duration="1000">
                            <div className="flex justify-center lg:justify-start ">
                                ...
                                >
                                    <img className="w-8 h-8" src={logo} alt="" /> <span className="text-fourth">Health Bridge</span>
                                </Link>
                            </div>

                            <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-primary lg:text-left">
                                Navigate the seas of creativity, charting new territories of thought with every post. Set sail on a journey of expression and discovery.
                            </p>
                        </div>
                    ...
                    <div className="flex items-end justify-center">
                        <p data-aos="fade-down" data-aos-duration="1000" className="lg:w-4/12 mx-auto text-center text-sm border-x-2 border-accent p-5 text-fourth font-bold">
                        ...
                        <div className="md:mt-0 md:block md:right-11 md:bottom-16 absolute right-5 bottom-1/4">
                            <a onClick={() => window.scroll({
                                ...
                                className="inline-block rounded-full hover:bg-fourth p-2 text-white shadow transition bg-accent sm:p-3 lg:p-4"
                            // href="#MainContent"
                            >
